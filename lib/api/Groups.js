...
const Bottleneck = require('bottleneck')
  ...
  , model = require('stream-lux-hue-bridge-model').model
  , Room = model.Room
...
/**
 * @typedef {import('stream-lux-hue-bridge-model').model.Entertainment} Entertainment
 * @typedef {import('stream-lux-hue-bridge-model').model.Group} Group
 * @typedef {import('stream-lux-hue-bridge-model').model.LightGroup} LightGroup
 * @typedef {import('stream-lux-hue-bridge-model').model.Lightsource} Lightsource
 * @typedef {import('stream-lux-hue-bridge-model').model.Luminaire} Luminaire
 * @typedef {import('stream-lux-hue-bridge-model').model.Room} Room
 * @typedef {import('stream-lux-hue-bridge-model').model.Zone} Zone
 */

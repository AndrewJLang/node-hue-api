...
const Bottleneck = require('bottleneck')
  ...
  , util = require('../util')
  , Light = require('stream-lux-hue-bridge-model').model.Light
;

/**
 * @typedef {import('stream-lux-hue-bridge-model').model.Light} Light
 * @typedef {import('stream-lux-hue-bridge-model').model.LightState} LightState
 * @type {Lights}
 */
